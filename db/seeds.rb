...
# DECK 2
deck2 = Deck.create(name:'Car Makes and Modles', description: 'Name the corresponding maker of each model')
...
guess = Guess.create(response:'Ford', card_id:card9.id, round_id: round3.id)
guess = Guess.create(response:'Mazda', card_id:card10.id, round_id: round3.id)
guess = Guess.create(response:'Cadillac', card_id:card11.id, round_id: round4.id)
...
guess = Guess.create(response:'Luxembourg City', card_id:card17.id, round_id: round5.id)
guess = Guess.create(response:'Tallinn', card_id:card18.id, round_id: round5.id)
guess = Guess.create(response:'Reykjavik', card_id:card19.id, round_id: round6.id)
...
guess = Guess.create(response:'Denver', card_id:card25.id, round_id: round7.id)
guess = Guess.create(response:'ATL', card_id:card26.id, round_id: round7.id)
guess = Guess.create(response:'PDX', card_id:card27.id, round_id: round8.id)

# DECK 5
deck5 = Deck.create(name:'Who created that?', description: 'Name the creator of this invention.')

card33 = Card.create(question:"Cinematograph", answer:"Thomas Edison", hint:"He failed like.. so many times.", deck_id: deck4.id)
card34 = Card.create(question:"Dynamite", answer:"Alfred Nobel", hint:"It's like he should have gotten some sort of 'prize'", deck_id: deck4.id)
card35 = Card.create(question:"Telescope", answer:"Hans Lippershey", hint:"Invented by Hans ___ in 1608", deck_id: deck4.id)
card36 = Card.create(question:"Telephone", answer:"Alexander Graham Bell", hint:"A.G.B", deck_id: deck4.id)
card37 = Card.create(question:"Safety pin", answer:"William Hurst", hint:"Don't prick yourself, it could really hur-st", deck_id: deck4.id)
card38 = Card.create(question:"Revolver", answer:"Samuel Colt", hint:"___ 45", deck_id: deck4.id)
card39 = Card.create(question:"Diesel engine", answer:"Rudolf Diesel", hint:"Its almost as if he named it after himself.", deck_id: deck4.id)
card40 = Card.create(question:"Aeroplane", answer:"Wright Brothers", hint:"Hmm.. it wasn't the Wrong brothers" deck_id: deck4.id)

round9 = Round.create(username: "Kellar", deck_id:deck5.id)
round10 = Round.create(username: "Kate", deck_id:deck5.id)

guess = Guess.create(response:'Thomas Edison', card_id:card33.id, round_id: round9.id)
guess = Guess.create(response:'Alfred Nobel', card_id:card34.id, round_id: round9.id)
guess = Guess.create(response:'Hans Lippershey', card_id:card35.id, round_id: round10.id)
