...
card4 = Card.create(question:"Whats 3 + 3?", answer:"6", hint:"hint 3", deck_id: deck2.id)
card5 = Card.create(question:"Whats 3 + 3?", answer:"6", hint:"hint 3", deck_id: deck.id)
card6 = Card.create(question:"Whats 3 + 3?", answer:"6", hint:"hint 3", deck_id: deck.id)
card7 = Card.create(question:"Whats 3 + 3?", answer:"6", hint:"hint 3", deck_id: deck2.id)
card8 = Card.create(question:"Whats 3 + 3?", answer:"6", hint:"hint 3", deck_id: deck.id)
